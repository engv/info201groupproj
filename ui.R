...
ui <- fluidPage(navbarPage(theme = "stylesheet.css",
  ...
  tabPanel(
    ...
    mainPanel(
      tags$p("We chose to dive deeper in the raw answers to the Big Five
...
There are a total of", tags$strong("19,719"), "entries that were recorded."),
      ...
      tags$p("The **IPIP** is an international non-profit organization that 
              compiles personality data around the world. We aim for our target
              audience to be those who have either already taken the personality
              test, and those who are interested in learning more about the
              distribution of different personality traits regarding the Big
